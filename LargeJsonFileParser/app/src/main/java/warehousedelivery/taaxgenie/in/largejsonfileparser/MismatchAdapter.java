...
public class MismatchAdapter extends RecyclerView.Adapter <MismatchAdapter.ViewHolder> {

    private static final String TAG =MismatchAdapter.class.getSimpleName() ;
    ...
    public MismatchAdapter(Context context, List<MismatchReports> mismatchReportsList, Boolean flags, String type, ProgressBar dialog) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        }else
        {
            ...
            Helper.Log(TAG, "bindView time: " + (System.currentTimeMillis() - startTime));
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.ll_invoice_financial_period)     TableRow ll_invoice_financial_period;
        @BindView(R.id.ll_invoice_no)                   TableRow ll_invoice_no;

        @BindView(R.id.mismatLayot)                     RelativeLayout mismatchLayot;
        @BindView(R.id.mismatch_type)                   TableRow mismatch_type;
        @BindView(R.id.mismatch_data)                   TableRow mismatch_data;
        @BindView(R.id.mismatch_date)                   TableRow mismatch_date;
        @BindView(R.id.mismatch_value)                  TableRow mismatch_value;
        @BindView(R.id.mismatch_igst)                   TableRow mismatch_igst;
        @BindView(R.id.mismatch_cgst)                   TableRow mismatch_cgst;
        @BindView(R.id.mismatch_sgst)                   TableRow mismatch_sgst;
        @BindView(R.id.cess)                            TableRow cess;
